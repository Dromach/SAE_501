 ...
 *              $ref: '#/components/schemas/Error'
 */
router.get(`/${base}/:id([a-f0-9]{24})`, routeName("authors_api"), async (req, res) => {
    const page = Math.max(1, Number(req.query.page) || 1);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post(`/${base}`, routeName("authors_api"), upload.single("image"), async (req, res) => {
    let imagePayload = {};
    let listErrors = [];
 ...
 *              $ref: '#/components/schemas/Error'
 */
router.put(`/${base}/:id([a-f0-9]{24})`, routeName("authors_api"), upload.single("image"), async (req, res) => {
    let imagePayload = {};
    let listErrors = [];
    let targetPath = undefined;
 ...
 *              $ref: '#/components/schemas/Error'
 */
router.delete(`/${base}/:id([a-f0-9]{24})`, routeName("authors_api"), async (req, res) => {
    try {
