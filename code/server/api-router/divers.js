...
router.post(`/${base}`, routeName("divers_api"), async (req, res) => {
...
router.get(`/${base}`, routeName("divers_api"), async (req, res) => {
...
router.get(`/${base}/:id([a-f0-9]{24})`, routeName("divers_api"), async (req, res) => {
    let listErrors = [];
